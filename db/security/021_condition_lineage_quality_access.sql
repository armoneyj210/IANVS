-- ============================================================
-- JANUS
-- Security Bootstrap 021
-- Condition Post-Canonical Lineage Quality
--
-- Quality receives only the narrow Condition evidence
-- interface.
--
...
-- ============================================================
-- 1. QUALITY MAY EXECUTE CONDITION DQ-006 EVIDENCE
-- ============================================================
